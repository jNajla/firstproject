...
public class Afficher extends Activity {
	...
	//tableau qui contients tous les nom des points privé
	String arr[];
	String arr2[];
	Double arrLat[];
	Double arrLong[];
	...
	protected void onCreate(final Bundle savedInstanceState) {
		...
		// recuperer tous les points privé
		recuperer_la_liste_des_points_prive();

		// ajouter un listener au champs à remplir
	...
	public void recuperer_la_liste_des_points_prive() {
		...
		for (int i = 0; i < PointPrive.size(); i++) {
			...
			Log.v("test", "les noms qui existent dans la base privé sont:   "
					+ arr[i]);
			// nb++;
		}
	}
